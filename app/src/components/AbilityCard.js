    ...
    render() {
        ...
        return (
            <>
                ...
                <div className='md:hidden rounded shadow-md p-3' onClick={this.toggle.bind(this)}>
                    <div className='w-full h-full flex flex-row justify-between items-center gap-3'>
                        <div className='flex flex-1 items-center gap-4'>
                            {this.props.children}
                            <h2 className='text-gray-700 text-base md:text-xl lg:text-2xl font-sans font-bold tracking-tight capitalize'>{title}</h2>
                        </div>
