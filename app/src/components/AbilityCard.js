    ...
    render() {
        ...
        return (
            <>
                ...
                <div className='md:hidden rounded shadow p-3 max-h-20' onClick={this.toggle.bind(this)}>
                    <div className='flex flex-row justify-between items-center gap-3 text-gray-800'>
                        <div className='flex flex-1 items-center gap-4'>
                            {this.props.children}
                            <h2 className='text-base md:text-xl lg:text-2xl font-sans font-bold tracking-tight capitalize max-h-12 overflow-hidden'>{title}</h2>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 flex-shrink-" viewBox="0 0 20 20" fill="currentColor">
