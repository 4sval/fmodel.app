            ...
            <div className='py-3.5'>
                <Layout>
                    <nav className='flex flex-row justify-evenly items-center gap-4 text-gray-800 whitespace-nowrap'>
                        ...
                        <div className='hidden flex-1 lg:flex flex-row justify-end items-center gap-4 text-xs'>
                            <a className='h-1/2 py-1 px-4 rounded font-medium hover:bg-gray-50 focus:ring-2 focus:ring-gray-100' href='/docs'>Documentation (Coming Soon)</a>
                        ...
                        <div className='lg:hidden flex-1 flex flex-row justify-end'>
                            <button className='py-1.5 px-2.5 rounded-full bg-gray-800 text-white'>
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
