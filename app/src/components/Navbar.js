        ...
        return (
            <div className='fixed md:relative z-10'>
                <div className='py-3.5'>
                    <Layout>
                        <nav className='flex flex-row md:justify-evenly items-center gap-4 text-gray-800 whitespace-nowrap'>
                            ...
                            <div className='hidden flex-1 md:flex flex-row justify-evenly lg:justify-end items-center gap-4 text-xs'>
                                <a className='py-1 px-4 rounded font-medium hover:bg-gray-50 focus:ring-2 focus:ring-gray-100' style={{ pointerEvents: 'none' }} href='/docs'>Documentation</a>
                                <a className='py-1 px-4 rounded font-medium hover:bg-gray-50 focus:ring-2 focus:ring-gray-100' href='/github' target="_blank">Source Code</a>
                                <a className='py-1 px-4 rounded font-medium hover:bg-gray-50 focus:ring-2 focus:ring-gray-100' href='/discord' target="_blank">Discord</a>
                                <a className='py-1 px-4 rounded font-medium hover:bg-gray-50 focus:ring-2 focus:ring-gray-100' href='/donate' target="_blank">Donate</a>
                            ...
                            </div>
                            {
                                ...
                                <div className='md:hidden z-10 absolute left-0 top-0 w-screen py-3.5 shadow-lg bg-gray-800'>
                                    <div className='flex flex-col items-center gap-2 text-sm text-center text-white'>
                                        ...
                                        <a className='py-1.5 w-1/2 rounded-sm font-medium text-white bg-blue-500' href='/download'>
                                            <div className='flex justify-center items-center gap-3'>
                                                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                                                    <path fillRule="evenodd" clipRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v3.586L7.707 9.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L11 10.586V7z" />
                                                </svg>
